...
using UnaClayChildminding.Services;

namespace UnaClayChildminding
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory, ChildmindingContext context)
        {
